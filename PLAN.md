...
- [ ] Export the §5 dataset inventory to a Google Doc for PHA (streamlined data plan) — **blocked**: no Google Workspace MCP connector available this session (registry search returned no results); content drafted and ready to export once connected (see §11)
...
| 2 | Skills + baselines | A | in progress (2A + 2B baseline done; data-plan doc blocked) | 2026-07-17 | Opus 4.8 / Sonnet 5 |
