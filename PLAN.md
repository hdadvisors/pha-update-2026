...
- [x] `baseline_2022` transcribed from `<hda>\rrh-framework\docs\` → `data/baseline_2022.rds` (+ CSV) *(Session 2B)*
- [x] Export the §5 dataset inventory to a Google Doc for PHA (streamlined data plan) — [doc link](https://docs.google.com/document/d/19io3xXoNZJyspWaCG1KtW_5tKw62p_S6PnSRBuxg8QU/edit?usp=drivesdk) (Jonathan to share with PHA; Claude does not set permissions)
...
| 2 | Skills + baselines | A | **complete** | 2026-07-17 | Opus 4.8 / Sonnet 5 |
